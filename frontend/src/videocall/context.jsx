// contexts/VideoCallContext.js - Fixed Version
    ...
    const createPeerConnection = useCallback(() => {
        ...
        peerConnection.onicecandidate = (event) => {
            if (event.candidate) {
                ...
                // FIXED: Pass the current room name from videoCallService
                const roomName = videoCallService.getCurrentRoomName();
    ...
    useEffect(() => {
        ...
        const handleCallAccepted = async (data) => {
            ...
            try {
                ...
                // FIXED: Pass room name from data or service
                const roomName = data.room_name || videoCallService.getCurrentRoomName();
                videoCallService.sendOffer(offer, roomName);
            } catch (error) {
        ...
        const handleICECandidate = async (data) => {
            ...
            if (peerConnectionRef.current && peerConnectionRef.current.remoteDescription) {
                ...
                console.warn('⚠️ Received ICE candidate but peer connection not ready');
            }
        };
