    ...
    try {
        ...
        Object.keys(formData).forEach(key => {
            ...
            if (key === 'profile_image' && value instanceof File) {
                ...
                // Ensure it's sent as string but will be converted to int on backend
                submitData.append(key, value.toString())
            } else if (key === 'consultation_fee') {
                // Ensure it's sent as string but will be converted to float on backend
                submitData.append(key, value.toString())
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-sm">
            ...
            <div className="flex justify-center mb-6">
                <div className="relative">
                    ...
                    <label htmlFor="profile-image" className="absolute bottom-0 right-0 bg-blue-900 rounded-full p-2 cursor-pointer hover:bg-blue-800 transition-colors">
