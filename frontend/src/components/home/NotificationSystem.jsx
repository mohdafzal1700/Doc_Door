...
const NotificationSystem = ({ isLoggedIn, className = "" }) => {
    ...
    <>
      <div className={`relative ${className}`}>
        <button
          ...
          className="relative flex items-center justify-center w-10 h-10 rounded-full hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors duration-200 group"
          title="Notifications"
        >
          <Bell size={20} className="text-gray-600 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400" />
          {unreadCount > 0 && (
